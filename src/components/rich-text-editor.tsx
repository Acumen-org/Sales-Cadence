...
export function RichTextEditor({ value, onChange, label, disabled = false }: {
  ...
  const editor = useEditor({
    ...
    content: value,
    editable: !disabled,
    editorProps: { attributes: { role: 'textbox', 'aria-label': label, 'aria-multiline': 'true', class: 'min-h-40 px-4 py-3 text-[14px] leading-7 text-ink-900 outline-none [&_a]:font-semibold [&_a]:text-brand-700 [&_a]:underline [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_p]:mb-2' } },
