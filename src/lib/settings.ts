...
export const RulesSettingsSchema = z.object({
   ...
   * exception so the next sync leaves it alone. The bare brands ("microsoft") cover the brand
   * top-level domains and the malformed hosts Twenty makes from system mail, like "mail.microsoft".
   */
  neverProspectDomains: z
    .array(z.string().trim().toLowerCase().min(1))
    .default(['microsoft.com', 'google.com', 'openai.com', 'anthropic.com', 'apple.com', 'amazon.com', 'meta.com', 'facebook.com', 'linkedin.com', 'salesforce.com', 'hubspot.com', 'zoom.us', 'slack.com', 'adobe.com', 'oracle.com', 'ibm.com', 'nvidia.com', 'github.com', 'atlassian.com', 'dropbox.com', 'docusign.com', 'calendly.com', 'microsoftonline.com', 'onmicrosoft.com', 'microsoft', 'google', 'apple', 'amazon', 'office.com', 'office365.com', 'sharepoint.com', 'azure.com', 'windows.net', 'amazonaws.com', 'googleusercontent.com', 'youtube.com', 'x.com', 'twitter.com', 'instagram.com', 'tiktok.com', 'stripe.com', 'intuit.com', 'quickbooks.com', 'godaddy.com', 'squarespace.com', 'wix.com', 'mailchimp.com', 'constantcontact.com', 'sendgrid.net', 'notion.so', 'canva.com', 'figma.com', 'asana.com', 'monday.com', 'trello.com', 'zendesk.com', 'intercom.io', 'twilio.com', 'okta.com', 'cloudflare.com', 'wordpress.com', 'shopify.com', 'paypal.com', 'uber.com', 'doordash.com', 'airbnb.com', 'booking.com', 'expedia.com', 'delta.com', 'united.com', 'aa.com', 'marriott.com', 'hilton.com']),
  neverProspectNames: z
    .array(z.string().trim().min(1))
    .default(['Microsoft', 'Google', 'Alphabet', 'OpenAI', 'Anthropic', 'Apple', 'Amazon', 'Amazon Web Services', 'Meta', 'Facebook', 'LinkedIn', 'Salesforce', 'HubSpot', 'Zoom', 'Slack', 'Adobe', 'Oracle', 'IBM', 'Nvidia', 'GitHub', 'Atlassian', 'Dropbox', 'DocuSign', 'Calendly', 'Microsoft Online', 'Microsoftonline', 'Microsoft Teams', 'Google Meet', 'Google Calendar', 'YouTube', 'Twitter', 'Instagram', 'TikTok', 'Stripe', 'Intuit', 'QuickBooks', 'GoDaddy', 'Squarespace', 'Wix', 'Mailchimp', 'Notion', 'Canva', 'Figma', 'Asana', 'Trello', 'Zendesk', 'Intercom', 'Twilio', 'Okta', 'Cloudflare', 'WordPress', 'Shopify', 'PayPal', 'Uber', 'DoorDash', 'Airbnb']),
  ...
  notAccountDomains: z
    .array(z.string().trim().toLowerCase().min(1))
    .default(['gmail.com', 'googlemail.com', 'outlook.com', 'hotmail.com', 'live.com', 'msn.com', 'yahoo.com', 'yahoo.co.uk', 'ymail.com', 'icloud.com', 'me.com', 'mac.com', 'aol.com', 'protonmail.com', 'proton.me', 'zoho.com', 'mail.com', 'yandex.com', 'yandex.ru', 'qq.com', '163.com', 'gmx.com', 'gmx.de', 'comcast.net', 'att.net', 'verizon.net', 'sbcglobal.net', 'mail.ru', 'inbox.ru', 'list.ru', 'bk.ru', 'rediffmail.com', 'rocketmail.com', 'btinternet.com', 'sky.com', 'live.co.uk', 'hotmail.co.uk', 'outlook.co.uk', 'yahoo.com.au', 'yahoo.ca', 'yahoo.in', 'yahoo.fr', 'yahoo.de', 'googlemail.co.uk', 'hey.com', 'fastmail.com', 'tutanota.com', 'pm.me', 'cox.net', 'charter.net', 'earthlink.net', 'optonline.net', 'bellsouth.net', 'roadrunner.com', 'frontier.com', 'windstream.net', 'centurylink.net', 'shaw.ca', 'rogers.com', 'telus.net', 'sympatico.ca', 'bigpond.com', 'optusnet.com.au', 'web.de', 'freenet.de', 't-online.de', 'orange.fr', 'free.fr', 'wanadoo.fr', 'laposte.net', 'libero.it', 'virgilio.it', 'telefonica.net', 'me.com']),
  /**
