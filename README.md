...
4. Open http://localhost:3100 and sign in with the `ADMIN_EMAIL` and `ADMIN_PASSWORD` from `.env`. Change that password from Settings, then add the rest of the team there.
